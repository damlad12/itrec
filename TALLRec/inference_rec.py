...
root_path = '/content/drive/MyDrive/EC523DL/RecRanker/RecRanker/conventional recommender/dataset/ml-100k_data_generated_for_RecRanker_training_and_testing/inference_results'
data_path = f'/content/drive/MyDrive/EC523DL/RecRanker/conventional recommender/dataset/ml-100k_data_generated_for_RecRanker_training_and_testing/test_ml-100k_MF_pointwise.jsonl'
INVALID_ANS = "[invalid]"
res_ins = []
res_answers = []
problem_prompt = (
...
def main(model_path: str ,lora_weights: str = "tloen/alpaca-lora-7b", start=0, end=MAX_INT, batch_size=1, tensor_parallel_size=1, share_gradio: bool = False,):
    ...
    data_path = f'/content/drive/MyDrive/EC523DL/RecRanker/RecRanker/conventional recommender/dataset/ml-100k_data_generated_for_RecRanker_training_and_testing/test_ml-100k_MF_pointwise.jsonl'
    base_model = f'/content/drive/MyDrive/EC523DL/Final_project/llama-7b'
    #tokenizer = LlamaTokenizer.from_pretrained(model)
    lora_weights = '/content/drive/MyDrive/EC523DL/Final_project/ml-100k'
