...
for dataset_name in dataset_names:
    ...
    if dataset_name == 'ml-100k':
        ...
        df_like = pd.read_csv(f'/content/drive/MyDrive/RecRanker/RecRanker/conventional recommender/dataset/ml-100k_data_generated_for_RecRanker_training_and_testing/train_set.txt', names=['u', 'i', 'r', 't'], sep=' ')
        df_dislike = pd.read_csv(f'/content/drive/MyDrive/RecRanker/RecRanker/conventional recommender/dataset/ml-100k_data_generated_for_RecRanker_training_and_testing/dislike.txt', header=None, names=['u', 'i', 'r', 't'])
        movie_info = pd.read_csv(f'/content/drive/MyDrive/RecRanker/RecRanker/conventional recommender/dataset/ml-100k_data_generated_for_RecRanker_training_and_testing/movie_info.csv', header=None,
        ...
        df_like_p = pd.read_csv(f'/content/drive/MyDrive/RecRanker/RecRanker/conventional recommender/dataset/ml-100k_data_generated_for_RecRanker_training_and_testing/train_set_prediction.csv', usecols=[0, 1, 2, 3])  # pointwise
    ...
    for modelname in model_names:
        ...
        idd = '1'
        kk = 5
        gt_list = pd.read_csv(f'/content/drive/MyDrive/RecRanker/RecRanker/conventional recommender/dataset/ml-100k_data_generated_for_RecRanker_training_and_testing/model_result/{modelname}gt_save_dict{idd}.csv', header=None,
                              names=['u', 'i'])

        rec_list = pd.read_csv(f'/content/drive/MyDrive/RecRanker/RecRanker/conventional recommender/dataset/ml-100k_data_generated_for_RecRanker_training_and_testing/model_result/{modelname}rec_save_dict{idd}.csv', header=None,
        ...
        ran_list = pd.read_csv(f'/content/drive/MyDrive/RecRanker/RecRanker/conventional recommender/dataset/ml-100k_data_generated_for_RecRanker_training_and_testing/my_test_list{modelname}.txt',
        ...
        with open(f'/content/drive/MyDrive/llmres_{modelname}_{dataset_name}_pairwise.txt',
                  'r') as f:
            lines = f.readlines()

        with open(f'/content/drive/MyDrive/llmres_{modelname}_{dataset_name}_pairwise_inv.txt',
                  'r') as f:
            lines2 = f.readlines()
        ...
        with open(f'/content/drive/MyDrive/llmres_{modelname}_{dataset_name}_pointwise.txt',
                  'r') as f:
            lines = f.readlines()
        ...
        with open(f'/content/drive/MyDrive/llmres_{modelname}_{dataset_name}_listwise.txt',
                  'r') as f:
            lines = f.readlines()
