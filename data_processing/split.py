...
import pandas as pd
root_path = '/content/drive/MyDrive/RecRanker/RecRanker/conventional recommender/dataset/ml-100k'
df_like = pd.read_csv(f'{root_path}/like.txt',header=None, names=['u', 'i', 'r','t'])
...
train_set.to_csv(f'{root_path}/train_set.txt', index=False, header=None, sep=' ')
val_set.to_csv(f'{root_path}/valid_set.txt', index=False, header=None, sep=' ')
test_set.to_csv(f'{root_path}/test_set.txt', index=False, header=None, sep=' ')
print("(Training set):")
print(train_set)
print("\n(Validation set):")
print(val_set)
