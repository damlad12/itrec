...
def train(
    ...
    print(f"train data pah: {train_data_path}")
    ...
    if train_data_path.endswith(".json"):  # todo: support jsonl
        ...
        flattened_data = [flatten_example(example) for example in train_data]
    ...
    dataset_path = "/content/drive/MyDrive/RecRanker/RecRanker/conventional recommender/dataset/ml-100k_data_generated_for_RecRanker_training_and_testing/ml-100k_pointwise.jsonl"
    ...
    # Map preprocessing function to train_data
    train_data = train_data.map(preprocess_data)
    
    # Apply prompt generation and tokenization
